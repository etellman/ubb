...
\begin{document}
  ...
  \ifprintanswers
    ...
    \begin{description}
      ...
      \item[67]
        \begin{description}
          \item[a] $f(0) = \unit[0]{ft/s}$

          \item[b] $f(5) \approx \unit[50.6]{ft/s}$; $f(10) \approx \unit[69.2]{ft/s}$

          \item[d] As $t$ gets larger and larger, the velocity gets closer and closer to $\unit[80]{f/s}$, so this is the
            terminal velocity.
      ...
      \item[68]
        \begin{description}
          \item[a] $P(5) \approx \unit[2.71904]{gallon}$
          \item[b] $P(10) \approx \unit[4.9452]{gallon}$

          \item[d] As time goes by, the water in the barrel becomes almost all the 0.3 lb/gal mixture.  50 gallons of
            this mixture would be 15 pounds of salt, so it makes sense that the value approaches 15 pounds.
