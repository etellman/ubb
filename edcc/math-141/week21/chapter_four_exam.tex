      ...
      \begin{parts}
        ...
        \part[7]
          ...
          \begin{solution}
            \begin{align*}
              \ln & \left[ \frac{ \sqrt{x + 2} \sqrt[3]{x - 1} }{ (x + 3)^4 } \right] \\
                  & = \ln (x + 2)^{1/2} + \ln(x - 1)^{1/3} - \ln (x + 3)^4 \\
                  & = \boxed{ \frac{1}{2} \ln (x + 2) + \frac{1}{3} \ln(x - 1) - 4 \ln (x + 3) } \\
            \end{align*}
          \end{solution}
    ...
    \question[7] Write as a single logarithm:
      \begin{parts}
        ...
        \part[7] $\log (x - 1) + \log(x + 1) - 2 \log \left( x^2 - 1 \right)$
          \begin{solution}
            \begin{align*}
              \log (x - 1) & + \log(x + 1) - 2 \log \left( x^2 - 1 \right) \\
                           & = \log [ (x - 1) (x + 1) ] - 2 \log \left( x^2 - 1 \right) \\
                           & = \log \left( x^2 - 1 \right) - 2 \log \left( x^2 - 1 \right) \\
                           & = - \log \left( x^2 - 1 \right) \\
                           & = \log \left( x^2 - 1 \right)^{-1} \\
                           & = \log \left( \frac{1}{ x^2 - 1 } \right) \\
            \end{align*}
          \end{solution}
    ...
    \question Solve for $x$
      \begin{parts}
        ...
        \part[7] $2e^{2x} - 7e^x - 4 = 0$
          ...
          \begin{solution}
            \begin{align*}
              \log_2(3x - 1) - \log_2(x - 1)             & = \log_2(x + 1) \\
              \log_2 \left( \frac{3x - 1}{x - 1} \right) & = \log_2(x + 1) \\
              \frac{3x - 1}{x - 1}                       & = x + 1 \\
              3x - 1                                     & = x^2 - 1 \\
              x^2 - 3x                                   & = 0 \\
              x(x - 3)                                   & = 0 \\
