    ...
    \item[42]
      ...
      \begin{parts}
        ...
        \part
          ...
          \dg$, $\sin A$, etc., I used $w$, $x$, and $y$ for the sines of the angles.  Since all of the sines cancel out
          in the end, this works out fine.
        ...
        \part
          \[
            r = \frac{4 \cdot 3}{4 - 3} = \boxed{ \unit[12]{cm} }
          \]

        \part
          If the radii are nearly equal, the radius becomes a very large number.  The side of a circle with a vary large
          radius is nearly a plane.
