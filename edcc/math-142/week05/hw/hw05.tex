  ...
  \ifprintanswers
    ...
    \begin{description}
      ...
      \item[40]
        ...
        Since the pressure varies by $\pm 10$, the amplitude is $10$.

        The maximum occurs 2 hours after midnight, so the phase shift is 2 hours.

        The function is
        \[
          \boxed{ p(t) = 90 + 10 \sin \frac{\pi}{12} (t - 2) }
        \]
              ...
              \item moving towards: 
                \begin{align*}
                  f(t) & = A \sin 554 \cdot 2 \pi t \\
                       & = A \sin 1108 \pi t \\
                       & \approx \boxed{ A \sin 3481 t } \\
                \end{align*}
              \item moving away: 
                \begin{align*}
                  f(t) & = A \sin 456 \cdot 2 \pi t \\
                       & = A \sin 912 \pi t \\
                       & \approx \boxed{ A \sin 2865 t } \\
                \end{align*}
            \end{itemize*}
        \end{enumerate}
      ...
      \item[44]
        \begin{enumerate}[(a)]
          \item $f(t) = 6 e^{-2.8 t} \cos 4 \pi t$
          \item
            \begin{align*}
              6 e^{-2.8 t} & = 0.5 \\
              t            & \approx \boxed{ \unit[0.887]{s} } \\
            \end{align*}
      ...
      \item[46]
        \begin{enumerate}[(a)]
          ...
          \item 
            \begin{align*}
              f(t) & = 3 e^{-0.8047t} \cos 165 \cdot 2 \pi \\
                   & = \boxed{ 3 e^{-0.8047t} \cos 330 \pi t } \\
            \end{align*}
