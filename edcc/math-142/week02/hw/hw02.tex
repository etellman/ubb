...
\begin{document}
  ...
  \ifprintanswers
    ...
    \begin{description}
      ...
      %     $\sin t$              & $\cos t$      & $\tan t$    & $\csc t$                & $\sec t$ & $\cot t$ \\
      %     \midrule
      %     $-\sfrac{\sqrt{3}}{2}$ & $\sfrac{1}{2}$ & $-\sqrt{3}$ & $-\sfrac{2 \sqrt{3}}{3}$ & $2$      & $-\sfrac{\sqrt{3}}{3}$ \\
      %     \bottomrule
      %   \end{tabular}
      ...
      %     $\sin t$       & $\cos t$              & $\tan t$                & $\csc t$ & $\sec t$                 & $\cot t$ \\
      %     \midrule
      %     $-\sfrac{1}{4}$ & $\sfrac{\sqrt{15}}{4}$ & $-\sfrac{\sqrt{15}}{15}$ & $-4$     & $\sfrac{4 \sqrt{15}}{15}$ & $-\sqrt{15}$ \\
      %     \bottomrule
      %   \end{tabular}
      ...
      %     $\sin t$                 & $\cos t$                & $\tan t$ & $\csc t$              & $\sec t$     & $\cot t$ \\
      %     \midrule
      %     $\sfrac{4 \sqrt{17}}{17}$ & $-\sfrac{\sqrt{17}}{17}$ & $-4$     & $\sfrac{\sqrt{17}}{4}$ & $-\sqrt{17}$ & $-\sfrac{1}{4}$ \\
      %     \bottomrule
      %   \end{tabular}
