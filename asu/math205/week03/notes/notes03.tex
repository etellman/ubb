...
\begin{document}
  ...
  % \begin{figure}[H]
  %   \centering
  %   \includegraphics[scale = 0.9]{figures/nfl/rush_yds_per_game.eps}
  ...
  % \begin{figure}[H]
  %   \centering
  %   \includegraphics[scale = 0.9]{figures/nfl/pts_per_game_bw5.eps}
  %   \caption{Points per game (bin width 5).}
  % \end{figure}
  
  % \begin{figure}[H]
  %   \centering
  %   \includegraphics[scale = 0.9]{figures/nfl/pts_per_game.eps}
