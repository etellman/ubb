...
\begin{document}
  ...
  \begin{questions}
    ...
    \question\label{q:exams.last}
      \begin{parts}
        
        \part[8] Draw box plots for the midterm and final\label{q:exams_box}

          \begin{solution}
            \begin{figure}[H]
              \centering
              \includegraphics[scale = 0.6]{figures/exams_box.pdf}
              \caption{Question 3 (\ref{q:exams_box})}\label{fig:exams_box}
            \end{figure}
          \end{solution}
    ...
    \question\label{q:point.histogram}
      ...
      \begin{parts}
        ...
        \ifprintanswers[]
          \begin{figure}[H]
            ...
            \caption{Question~\ref{q:point.histogram}}\label{fig:point.histogram}
          \end{figure}
        \fi
        ...
        \part[6] Draw a box plot for both players
          \begin{solution}
            \begin{figure}[H]
              ...
              \caption{James vs. Durant Points}\label{fig:james_vs_durant}
            \end{figure}
          \end{solution}
      ...
      % \uplevel{
        ...
        %     \bottomrule
        %   \end{tabular}
        %   \caption{Shots by position}\label{tab:sbp}
        % \end{table}
      % }
