    ...
    \begin{description}
      ...
      \item[48]
        ...
        \part
          ...
          These distributions are almost exactly what you would expect for a normal
          distribution.  There are probably only one or two big samples at the high end of
          the range.  This would explain the high maximum value with everything else being
          what you would expect from a normal distribution.
