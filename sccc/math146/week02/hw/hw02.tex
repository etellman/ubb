...
\begin{document}
  ...
  \else
    \begin{itemize*}
      ...
      \item hand in exercises 25-27, 29-30, 37-39, 41-45, 50-51
    \end{itemize*}
  \fi
    ...
    \begin{description}
      ...
      \item[32]
        \begin{parts}
          ...
          \part 
            \begin{itemize*}
              \item for the men, $\bar{x}$ went from 117.17 to 110.86 and $s$
                went from 74.24 to 66.88
              \item for the women, $\bar{x}$ went from 165.17 to 158.45 and $s$
                went from 56.51 to 43.65
            \end{itemize*}
      ...
      \item[45]
        ...
        \begin{figure}[H]
          \centering
          \includegraphics{figures/ex45.eps}
          \caption{Exercise 45}
        \end{figure}
