    ...
    \question
      ...
      \begin{parts}
          ...
          \begin{solution}
            \begin{table}[H]
              ...
              \begin{tabular}{lrrrrrr}
                \toprule
                Player & Min. & 1st Qu. & Median & 3rd Qu. & Max. \\
                \midrule
                Durant & 13   & 25      & 31     & 34.50   & 42 \\
                James  & 13   & 22      & 26     & 32.50   & 36 \\
                \bottomrule
              \end{tabular}
            \end{table}
        ...
        \part[6] Draw a box plot for both players
          \begin{solution}
            See Figure \ref{fig:james_vs_durant}
          \end{solution}

          \ifprintanswers
            \begin{figure}[H]
              \centering
              \includegraphics{figures/james_vs_durant.pdf}
        ...
        \begin{parts}
          ...
          \part[5] What percentage of the three point shooters in the NBA are less
            ...
            \begin{solution}
              ...
              \fbox{ 0.8849 or 88.5\% } of players have scores lower than 1.2.
            \end{solution}
      ...
      \begin{parts}
        \part[7]
          ...
          \begin{solution}
            ...
            \[
              b = -0.6020 \cdot \frac{17.5}{5.7} \approx -1.845
            \]

            Use the slope and the means to find the y-intercept:
            \begin{align*}
              \bar{y} & = -1.845 \bar{x} + a \\
              5.7     & = -1.845 \cdot 30.5 + a \\
              a       & \approx 40.13 \\
            \end{align*}
        ...
        \begin{solution}
          See Figure \ref{fig:draft} (slightly steeper regression line).
        \end{solution}
        ...
        \begin{solution}
          ...
          Both regression lines are in Figure \ref{fig:draft}.
        \end{solution}
      \end{parts}
