...
\begin{document}
  ...
  \else
    ...
    % Some of the problems are very tedious to do without a calculator or computer
    % that can compute correlation and regression lines.  To make things easier, I
    % did this stuff on my computer so you'll have the numbers even if you don't
    % have an expensive calculator.
