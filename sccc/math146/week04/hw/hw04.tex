    ...
    \begin{description}
      ...
      \item[39]
        \begin{parts}
          ...
          \part Correlations are always between 1 and -1.
      ...
      \item[44]
        ...
        There is a fairly strong (-0.7943) correlation between breeding pairs
        and returning pairs.  The more breeding pairs there are, the fewer pairs
        return each year.
    \end{description}
