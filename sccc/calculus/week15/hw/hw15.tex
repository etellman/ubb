  ...
  \begin{description}
    ...
    \item[47] 
      ...
      \begin{itemize*}
        ...
        \item \fbox{ Minimum: $f(2) = -7$ } 
        \item \fbox{ Maximum: $f(0) = 5$ } 
      \end{itemize*}
    ...
    \item[48] 
      ...
      \begin{itemize*}
        ...
        \item \fbox{ Minimum: $f(1) = -1$ } 
        \item \fbox{ Maximum: $f(3) = 19$ } 
      \end{itemize*}
    ...
    \item[51] 
      ...
      \begin{itemize*}
        ...
        \item \fbox{ Minimum: $f(-1) = 2$ and $f(1) = 2$ }
        \item \fbox{ Maximum: $f(3) = 66$ } 
      \end{itemize*}
    ...
    \item[53] 
      ...
      \begin{itemize*}
        \item Critical Points: $(0, 0)$, $\del{ 1, \sfrac{1}{2} }$ and $\del{ 2, \sfrac{2}{5} }$
        \item \fbox{ Minimum: $f(0) = 0$ }
        \item \fbox{ Maximum: $f(1) = \sfrac{1}{2}$ } 
      \end{itemize*}
    ...
    \item[56] 
      ...
      \begin{itemize*}
        ...
        \item \fbox{ Minimum: $f(0) = 0$ and $f(8) = 0$ }
        \item \fbox{ Maximum: $f(2) = 6 \sqrt[3]{2}$ } 
      \end{itemize*}
